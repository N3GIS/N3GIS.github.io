...
var loadScene = {
    createScene: function (modelsRoot, sceneName, canvas, callback) {
        ...
        function loadSceneByJson(jsonData) {
            ...
            if (engine == null) {
                engine = new BABYLON.Engine(canvas, true, { preserveDrawingBuffer: true, stencil: true, disableWebGL2Support: false }, false);
            ...
            //Version 4.2 and below(4.2及以下版本)
            //var registeredPlugin = BABYLON.SceneLoader._registeredPlugins[".babylon"];

            var registeredPlugin = BABYLON.SceneLoader.GetDefaultPlugin(); //Version 5.0
